    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">Lengkapi informasi produk dengan detail</p>
            </div>
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="px-6 py-6 space-y-8">
                    ...
                    <div id="product-info-no-variant">
                    ...
                    <div id="variant-settings" class="hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="variant_name_1" id="variant_name_1" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="Contoh: Warna" value="{{ old('variant_name_1') }}">
                                </div>
                                <div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg mb-4">
                            ...
                            <div id="variant-2-fields" class="hidden">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama Varian</label>
                                        <input type="text" name="variant_name_2" id="variant_name_2" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                               placeholder="Contoh: Ukuran" value="{{ old('variant_name_2') }}">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Opsi Varian</label>
                        ...
                        <div id="variant-combinations" class="hidden">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                                    <thead class="bg-gray-50">
                                        <tr id="variant-table-header">
                                            ...
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" id="variant-1-header">Varian 1</th>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden" id="variant-2-header">Varian 2</th>
